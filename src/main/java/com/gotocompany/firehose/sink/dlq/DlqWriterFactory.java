...
import com.gotocompany.firehose.utils.KafkaConnectorType;
    ...
    public static DlqWriter create(Map<String, String> configuration, StatsDReporter client, Tracer tracer) {
        ...
        switch (dlqConfig.getDlqWriterType()) {
            case KAFKA:
                ...
                KafkaProducer<byte[], byte[]> kafkaProducer = KafkaUtils.getKafkaProducer(KafkaConnectorType.DLQ, dlqKafkaProducerConfig, configuration);
