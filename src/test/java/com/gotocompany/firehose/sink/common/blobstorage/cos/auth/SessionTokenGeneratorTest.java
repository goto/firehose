...
public class SessionTokenGeneratorTest {
    ...
    public void testGetCOSCredentials() {
        ...
        SessionTokenGenerator generator = new SessionTokenGenerator(cloudObjectStorageConfig);
    ...
    public void testGetResource() {
        ...
        for (String[] testCase : cases) {
            ...
            try {
                Method method = SessionTokenGenerator.class.getDeclaredMethod("getResource");
                method.setAccessible(true);
                String resource = (String) method.invoke(generator);
